...
if (language.startsWith('zh')) {
  ...
  help_source = '5. Interaction between program text and LLM text: The source text of markdown cells and code cells can be directly referenced in the current kernel program in the form of _refs["unique id"], facilitating users to perform text input and output interactions between Python and LLM. <br><br>';
