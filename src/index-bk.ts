  ...
  implements DocumentRegistry.IWidgetExtension<NotebookPanel, INotebookModel>
{
  ...
  createNew(
    ...
    this.chatButton.creationTimestamp = this.creationTimestamp;
    console.log('Chat Button Created at:', this.creationTimestamp);
  ...
  async chatCellData(panel: NotebookPanel): Promise<void> {
    try {
      ...
      console.log('Outer Chat Button Start Rotation:', this.creationTimestamp);
    ...
    console.log('Outer Chat Button Stop Rotation:', this.creationTimestamp);
